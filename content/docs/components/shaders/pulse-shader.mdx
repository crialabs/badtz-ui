...
<Step>Copy and paste the `pulse-shader` code into your project.</Step>
...
(event.clientX / window.innerWidth) _ 2 - 1,
-(event.clientY / window.innerHeight) _ 2 + 1
);
...
<Step>Copy and paste the `pulse-shader-scene` code into your project.</Step>
