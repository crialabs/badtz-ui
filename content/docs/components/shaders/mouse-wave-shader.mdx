...
<ComponentPreview
  ...
  v0Link="https://badtz-ui.com/r/mouse-wave.json"
>
...
<Step>Copy and paste the `mouse-wave-shader` code into your project.</Step>
...
gx0 -= sz0 _ (step(0.0, gx0) - 0.5);
gy0 -= sz0 _ (step(0.0, gy0) - 0.5);
...
gx1 -= sz1 _ (step(0.0, gx1) - 0.5);
gy1 -= sz1 _ (step(0.0, gy1) - 0.5);
...
vUv = uv;
gl_Position = projectionMatrix _ modelViewMatrix _ vec4( newposition, 1.0);
}
`;
...
<Step>Copy and paste the `mouse-wave` code into your project.</Step>
...
<Step>Copy and paste the `mouse-wave-scene` code into your project.</Step>
...
<li className="text-sm text-muted-foreground mt-4">
  The GLSL shader used in this component was created by{" "}
  <MdxLink href="https://github.com/stegu/">@stegu</MdxLink>
</li>
