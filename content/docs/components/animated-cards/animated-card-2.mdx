...
<Step>Copy and paste the `visual-2` code into your project.</Step>
...
const mainDashoffset = circumference - (mainProgress / 100) _ circumference;
const secondaryDashoffset =
circumference - (secondaryProgress / 100) _ circumference;
