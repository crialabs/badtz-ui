...
<ComponentPreview
  ...
  description="This component provides a dynamic and visually captivating way to display images split into multiple sections."
  v0Link="https://badtz-ui.com/r/image-split.json"
>
...
<Step>Copy and paste the `image-split` code into your project.</Step>
...
<li className="text-sm text-muted-foreground mt-4">
  ...
  <MdxLink href="https://reflect.app/">Reflect</MdxLink>
</li>
