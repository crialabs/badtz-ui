...
<ComponentPreview
  ...
  v0Link="https://badtz-ui.com/r/expandable-card.json"
>
...
<Step>Copy and paste the `expandable-card` code into your project.</Step>
...
<li className="text-sm text-muted-foreground mt-4">
  ...
  <MdxLink href="https://linear.app/">Linear</MdxLink>
</li>
