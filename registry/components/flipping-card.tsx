...
export function FlippingCard({
  ...
  return (
    <div className="group/flipping-card [perspective:1000px]">
      <div
        className={cn(
          `relative h-[${height}px] w-[${width}px] rounded-xl border border-neutral-200 bg-white shadow-lg transition-all duration-700 [transform-style:preserve-3d] group-hover/flipping-card:[transform:rotateY(180deg)] dark:border-neutral-800 dark:bg-neutral-950`,
          className
        )}
      >
        {/* Front Face */}
