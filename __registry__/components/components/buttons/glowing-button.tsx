...
export function GlowingButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "h-10 !px-5 text-sm rounded-lg border flex items-center justify-center relative transition-colors overflow-hidden bg-gradient-to-t border-r-0 duration-200",
